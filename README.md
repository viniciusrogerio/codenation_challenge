...
<span style="color:red">Atenção:</span> o token em questão foi obtido através da plataforma Codenation exclusivamente pelos participantes do desafio, para tornar possível o acesso à API e a identificação do participante. Qualquer tentativa de acesso a partir do token que consta no código não será bem sucedida.
